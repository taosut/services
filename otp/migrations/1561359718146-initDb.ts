...
export class initDb1561359718146 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `sms_configuration` (`id` varchar(36) NOT NULL, `accountSid` varchar(255) NULL, `authToken` varchar(255) NULL, `sender` varchar(255) NULL, `isActive` tinyint NOT NULL DEFAULT 0, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `sms_otp` (`id` varchar(36) NOT NULL, `phoneNumber` varchar(255) NOT NULL, `otp` varchar(255) NOT NULL, `invalid` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
