...
export class CreateTrackCompletionDto {
  ...
  @ApiModelProperty({required: true, type: 'string', description: 'Strings must be uuid and uuid is available in tracks'})
  // tslint:disable-next-line: variable-name
...
export class UpdateTrackCompletionDto {
  @ApiModelProperty({required: false})
  // tslint:disable-next-line: variable-name
  readonly total_progress: string;
  @ApiModelProperty({required: false})
