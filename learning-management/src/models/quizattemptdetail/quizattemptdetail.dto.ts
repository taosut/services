...
export class CreateQuizAttemptDetailDto {
...
// tslint:disable-next-line: variable-name
  ...
  @ApiModelProperty({required: true, type: 'string', description: 'Strings must be uuid and uuid is available in quiz attempt list'})
// tslint:disable-next-line: variable-name
  readonly quiz_attempt_id: string;
}

// tslint:disable-next-line: max-classes-per-file
export class UpdateQuizAttemptDetailDto {
  @ApiModelProperty({required: true})
  readonly question: string;
  @ApiModelProperty({required: false})
// tslint:disable-next-line: variable-name
